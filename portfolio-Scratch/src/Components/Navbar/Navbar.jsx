...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`${scrolled ? " flex justify-center items-center transition-all duration-300":"h-[50px]  my-5  px-[40px] mx-auto   flex justify-between items-center lg:mt-5 lg:max-w-[1400px] "}   md:sticky top-0 lg:top-5  z-[99999] navbar   ${
          scrolled ? "bg-slate-100 bg-blur py-2 rounded-full max-w-[500px]  mx-auto transition-all duration-300" : "bg-white"} font-poppins`}
        id="Navbar"
      >
        <div className={`${scrolled ? 'hidden' : 'text-black text-[16px] lg:text-[20px] flex items-center font-bold'} font-poppins`}>Jeevan.dev</div>
